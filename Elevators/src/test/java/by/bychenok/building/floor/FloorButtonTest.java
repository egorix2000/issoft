...
class FloorButtonTest {
    ...
    class SingleFloor {
        ...
        void press_success() {
            ...
            FloorButton button = new FloorButton(1, UP, requests, 20);
    ...
    class TwoFloors {
        ...
        void press_pressOnDifferentFloors_success() {
            ...
            ElevatorsManager elevatorsManager = mock(ElevatorsManager.class);
            BlockingQueue<ElevatorRequest> requests = new LinkedBlockingQueue<>();
            FloorButton button1 = new FloorButton(1, UP, requests, 20);
            FloorButton button2 = new FloorButton(2, UP, requests, 20);
