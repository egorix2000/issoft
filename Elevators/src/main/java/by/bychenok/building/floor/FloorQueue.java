...
public class FloorQueue {
    ...
    public FloorQueue(int floorNumber,
        ...
        this.button = new FloorButton(floorNumber, direction, requests, numberOfFloors);
        people = new LinkedList<>();
        statisticsCollector = StatisticsCollector.getStatisticsCollectorInstance(numberOfFloors);
    }
